...
namespace JobIntelligence.Infrastructure.Migrations
{
    ...
    [Migration("20260322183441_AddWorkdayTenantId")]
    partial class AddWorkdayTenantId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobIntelligence.Core.Entities.Company", b =>
                {
                    ...
                    b.Property<string>("WorkdayTenantId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("workday_tenant_id");
